...
class QuizList extends Component {
  ...
  renderQuizInfo() {
    ...
    return (
      <div>
        <h2 className="header">{saveSelectedQuizObj.quizName} Quiz</h2>
              ...
              <div className="col-md-4" key={`${qList}_${index}`}>
                <div className="card" style={{ width: "50rem" }}>
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      Test your skills of {qList.quizName} by taking this small
                      quiz. It has {qList.tests} tests.
                      <br />
                      Note: Quiz is related to {qList.quizName} technology .....
                      happy learning..
                    </p>
                    <button
                      className="btn"
